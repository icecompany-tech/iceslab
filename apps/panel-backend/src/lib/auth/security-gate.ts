...
import { notifyTelegramAsync, escapeMarkdown } from '../notify/telegram-notify.js';
import { honeypotHits, geoBlockDenials } from '../infra/metrics.js';
import { isPublicRoutableIp } from '../util/ip.js';
