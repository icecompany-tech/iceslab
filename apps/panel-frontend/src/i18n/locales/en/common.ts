export const common = {
  ...
  nodeCore: {
    ...
    unpinnedInstall: {
      ...
      'no-asset': 'Version not pinned: the release has no build for the node arch ({{arch}}). The script installs its own default.',
      unpinned: 'Version not pinned: there is nothing to pin (no release in the manifest). The script installs its own default.',
    },
  ...
  breadcrumb: {
    ...
    namedOutbounds: '/ TRAFFIC · NAMED OUTBOUNDS',
