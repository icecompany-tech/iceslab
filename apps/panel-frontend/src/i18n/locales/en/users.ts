export const users = {
  users: {
    title: 'Users',
    create: 'Create user',
    searchPlaceholder: 'Search by username, email, tag, short id or telegram id…',
    empty: 'No users.',
  ...
  usersTable: {
    ...
    filterNo: 'Has none',
    filterHas: 'Value',
    filterAfter: 'Not before',
    filterBefore: 'Not after',
    filterOver: 'Over, GB',
    filterUnder: 'Under, GB',
    filterNode: 'Node',
    filterNodeNone: 'Never connected',
    filterOnline: 'Right now',
    // Keyed by parameter, not by value: `set` means "has a device limit" under
    // one heading and "has an email" under another, and its opposite is
    // `unset` in one and `none` in the other. Taken from the server verbatim.
    filterValue: {
      trafficLimit: { limited: 'Limited', unlimited: 'Unlimited' },
      deviceLimit: { set: 'Limit set', unset: 'No limit' },
      telegram: { linked: 'Linked', none: 'Not linked' },
      email: { set: 'Filled in', none: 'Empty' },
      revoked: { yes: 'Revoked', no: 'Live' },
      hasTag: { yes: 'Tagged', no: 'Untagged' },
      hasExpiry: { yes: 'Has expiry', no: 'Never expires' },
      online: { online: 'Online', offline: 'Offline', never: 'Never been' },
    },
