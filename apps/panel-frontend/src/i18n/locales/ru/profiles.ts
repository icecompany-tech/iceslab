export const profiles = {
  ...
  recipes: {
    ...
    import: {
      ...
      hint: 'Вставь ссылку на рецепт (страница файла GitHub, gist или raw) или JSON рецепта. Он валидируется, потом выбираешь какой применить. Ничего не сохраняется.',
