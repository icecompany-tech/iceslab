  ...
  profiles: {
    ...
    form: {
      ...
      plain: {
        ...
        udp: 'UDP выключен: звонки Telegram через SOCKS5 UDP не ходят, клиент UDP associate не использует. Переключатель появится, когда сервер начнёт принимать это поле.',
