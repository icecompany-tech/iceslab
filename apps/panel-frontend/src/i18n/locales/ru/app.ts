export const app = {
  sidebar: {
    ...
    trafficGroup: 'Трафик',
    // Дверь называется тем же словом, что и три вкладки за ней: «Правила
    ...
    // Слово на самой строке, а не только в подсказке: восемь таких пунктов
    // выглядели точно как живые, а наведением их никто не проверяет.
    notWiredTag: 'нет экрана',
    systemGroup: 'Система',
    insights: 'Аналитика',
